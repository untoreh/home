;;; ../../../var/home/fra/.doom.d/mail.el -*- lexical-binding: t; -*-
(setq-default
 mu4e-maildir "~/.mail"
...
(after! mu4e
  ...
  (set-email-account!
   ...
   '((mu4e-sent-folder       . "/criptafra@gmail.com/\[Gmail\]/Sent Mail")
     ...
     (smtpmail-smtp-service . 465)) t)
  (set-email-account!
   "e-francesco.giannelli@yahoo.it"
